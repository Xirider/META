...
def train():
    ...
    if args.local_rank in [-1, 0]:
        ...
        trainer.add_event_handler(Events.ITERATION_COMPLETED_COMPLETED, checkpoint_handler, {'mymodel': getattr(model, 'module', model)})  # "getattr" take care of distributed encapsulation
