...
class QBert():
    ...
    def get_answer(self, q = None):
        ...
        batch_list = build_input_batch(articlelist = articlelist, question= query, tokenizer = self.tokenizer, batch_size = self.args.batch_size, onlyone=self.args.more_than_one)
