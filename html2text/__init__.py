        ...
        if tag == "img" and start and not self.ignore_images:
            if "src" in attrs:
                ...
                if self.images_to_alt:
                    ...
                    self.o(" [imagestart] " + escape_md(alt) + " [imageend] ")
                    if self.inline_links and self.long_version:
        ...
        if tag == "li":
            ...
            if start:
                ...
                if li["name"] == "ul":
                    ...
                    self.o("[unorderedlist] ")
                    
                elif li["name"] == "ol":
                    li["num"] += 1
                    #self.o(str(li["num"]) + ". ")
                    self.o("[orderedlist] " +str(li["num"]) + ". ")
                self.start = True
            else:
                if self.long_version:
                    self.o(" </{}> ".format(tag))
