...
CSS = {
    'head': HtmlElement('head', display=Display.block),
    ...
    'title': HtmlElement('title', display=Display.block),
    'style': HtmlElement('style', display=Display.none),

    'p': HtmlElement('p', display=Display.block, margin_before=1, margin_after=0),
    'figure': HtmlElement('figure', display=Display.block, margin_before=1, margin_after=0),


    'h1': HtmlElement('h1', display=Display.block, margin_before=1, margin_after=0),
    'h2': HtmlElement('h2', display=Display.block, margin_before=1, margin_after=0),
    'h3': HtmlElement('h3', display=Display.block, margin_before=1, margin_after=0),
    'h4': HtmlElement('h4', display=Display.block, margin_before=1, margin_after=0),
    'h5': HtmlElement('h5', display=Display.block, margin_before=1, margin_after=0),
    'h6': HtmlElement('h6', display=Display.block, margin_before=1, margin_after=0),

    'ul': HtmlElement('ul', display=Display.block, margin_before=0, margin_after=0, padding=0),
    'ol': HtmlElement('ol', display=Display.block, margin_before=0, margin_after=0, padding=0),
    'li': HtmlElement('li', display=Display.block, margin_before=1),
    'code': HtmlElement('code',),
    'tr': HtmlElement('tr', display=Display.block, margin_before=0, margin_after=0, padding=0),
    'td': HtmlElement('td', ),
    'th': HtmlElement('th', ),
